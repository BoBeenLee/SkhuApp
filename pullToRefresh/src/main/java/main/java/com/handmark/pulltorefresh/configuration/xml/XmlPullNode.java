 ...
 * If you implement {@link com.handmark.pulltorefresh.configuration.xml.XmlPullNode#XmlPullNodeCallback} and pass that on to this class,<br /> {@link XmlPullNodeParser} calls {@link com.handmark.pulltorefresh.configuration.xml.XmlPullNode#XmlPullNodeCallback#process(XmlPullParser)} when it has found this current node during parse.<br />
...
class XmlPullNode {
	 ...
	 * If you add a child (by calling {@link #addChildNode(com.handmark.pulltorefresh.configuration.xml.XmlPullNode, int)} with setting repeat limit and the limit is {@code INFINITE}, the limit becomes meaningless.<br />
	 */
	 ...
	 * 
	 * NOTE: If you implement {@link com.handmark.pulltorefresh.configuration.xml.XmlPullNode#XmlPullNodeCallback} and pass that on to {@code XmlPullNode} class,<br /> {@link XmlPullNodeParser} calls {@link com.handmark.pulltorefresh.configuration.xml.XmlPullNode#XmlPullNodeCallback#process(XmlPullParser)} when it has found this the node during parse.
	 * @author Wonjun Kim
	 *
	 */
